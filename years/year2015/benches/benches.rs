...
pub fn criterion_benchmark(c: &mut Criterion) {
    let input = read_to_string("./input/2015/day1.txt").unwrap();
    ...
    let input = read_to_string("./input/2015/day2.txt").unwrap();
    let input = input.as_str();
    ...
    let input = read_to_string("./input/2015/day4.txt").unwrap();
    let input = input.as_str();
    ...
    let input = read_to_string("./input/2015/day5.txt").unwrap();
    let input = input.as_str();
    ...
    let input = read_to_string("./input/2015/day6.txt").unwrap();
    let input = input.as_str();
